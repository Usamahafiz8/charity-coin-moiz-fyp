    ...
    <div className="relative flex flex-col items-center justify-center gap-8 min-h-screen overflow-hidden px-4 md:px-8">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">
          Maximize your token impact with <br />
          our no fee model.
        </h1>
        <p className="mt-6 text-lg md:text-xl text-white font-light">
          With token for Charity, 100% of the net proceeds of your donation
      ...
      <section className="flex flex-col md:flex-row gap-8 items-center bg-gray-700/60 p-6 rounded-lg shadow-lg backdrop-blur-lg w-full max-w-5xl">
        <div className="text-center md:text-left md:w-1/2">
          ...
          <p className="mt-4 text-lg text-white">
            You can make an impact anytime. We take care of the rest, supporting
            philanthropy via cryptocurrency.
          </p>
          <button
            className="mt-4 bg-green-600 text-white px-5 py-2 rounded-full hover:bg-green-500 transition"
            onClick={() => setIsVisible(true)}
          >
            Donate Directly
          </button>
      ...
      <section className="flex flex-col md:flex-row gap-8 items-center bg-gray-700/60 p-6 rounded-lg shadow-lg backdrop-blur-lg w-full max-w-5xl">
        ...
        <div className="text-center md:text-left md:w-1/2">
          <h2 className="text-3xl font-semibold text-white">
            Why donate token instead of cash?
          </h2>
          <p className="mt-4 text-lg text-white">
            Donating token is not just for the greater good, it’s also strategic
            for you. You can:
          </p>
          ...
          <Link
            href="/about"
            className="mt-4 inline-block bg-green-600 text-white px-5 py-2 rounded-full hover:bg-green-500 transition"
          >
            Learn more
          </Link>
        </div>
      ...
      <section className="bg-gray-700/60 p-6 rounded-lg shadow-lg backdrop-blur-lg w-full max-w-5xl">
        ...
        <form className="mt-6 flex flex-col space-y-4">
          <input
            type="text"
            placeholder="Name"
            className="px-4 py-2 bg-gray-800 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600"
          />
          <input
            type="email"
            placeholder="Email"
        ...
        {isVisible && (
          ...
          >
            <div className="bg-white p-6 rounded-lg text-center max-w-md">
              ...
              <button
                className="mt-4 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-500 transition"
