  ...
  return (
    <div className="min-h-screen bg-gray-100 flex  p-8">
      <div className="bg-white p-8 rounded-lg shadow-lg w-screen ">
        <h2 className="text-4xl font-bold mb-6 text-gray-800 text-center">About Charity Foundation</h2>
        ...
        <h3 className="text-2xl font-bold mb-4 text-gray-800">What is Charity Coin?</h3>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <h3 className="text-2xl font-bold mb-4 text-gray-800">Join Us in Making a Difference</h3>
        <p className="text-lg text-gray-700 mb-6">
